...
import { ApisaudeService } from '../services/apisaude.service';
import { InfiniteScrollCustomEvent } from '@ionic/angular';

@Component({
  selector: 'app-apisaude',
  templateUrl: './apisaude.page.html',
  styleUrls: ['./apisaude.page.scss'],
})
export class ApisaudePage implements OnInit {
  ...
  constructor(public apisaudeService: ApisaudeService, private navCtrl: NavController) { }
  ...
  carregaPagina() {
    this.apisaudeService.getgNews(this.apikey, this.page).subscribe(
      (data: any) => {
